# SAP NetWeaver on SAP ASE Module

A Terraform module that will create the the following AWS Resources to build and deploy a SAP NetWeaver on ASE Solution.
...
* [Tags](./modules/_internal-modules/common/tagging)
...
* [SAP ASE Instance Module](./modules/aws-sap-ase-host)
